...
namespace ODOOdotnetcore.Models
{
    public partial class ResPartner
    {
        ...
        public ResPartner CommercialPartner { get; set; }
        public ResPartner Parent { get; set; }
        public ICollection<ResPartner> InverseCommercialPartner { get; set; }
        public ICollection<ResPartner> InverseParent { get; set; }
    }
}
